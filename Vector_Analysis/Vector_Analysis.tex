...
\begin{center}
    \Large{\underline{矢量分析与场论}} \footnotesize{12FEB2018}
\end{center}
...
基向量与其导数正交。
\begin{align}
    \frac{\pd\be_1}{\pd q_1}=&-\frac{\be_2}{H_2}\frac{\pd H_1}{\pd q_2}-\frac{\be_3}{H_3}{\pd H_1}{\pd q_3}\\
    \frac{\pd\be_1}{\pd q_2}=&\frac{\be_2}{H_1}\frac{\pd H_2}{\pd q_1}\\
...
\begin{align}
    ...
    &\nabla\cdot\bA=\frac{1}{\rho}\frac{\pd\rho A_\rho}{\pd \rho}+\frac{1}{\rho}\frac{\pd A_\phi}{\pd \phi}+\frac{1}{\rho}\frac{\pd\rho A_z}{\pd z}\\
...
\begin{align}
    ...
    &\nabla^2 u=\frac1r\frac{\pd^2ru}{\pd r^2}+\frac{1}{r^2\sin\theta}\dfrac{\pd}{\pd\theta}\left(\sin\theta\frac{\pd u}{\pd\theta}\right)+\frac{1}{r^2\sin^2\theta}\frac{\pd^2u}{\pd\phi}
\end{align}
